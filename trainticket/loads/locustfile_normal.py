...
def get_trip_information(client, from_station, to_station):
    ...
    def api_call_get_trip_information():        
        ...
        response = client.post(url="/api/v1/travelservice/trips/left", json=body, catch_response=False, name=get_name_suffix("get_trip_information"))
        response_as_json = get_json_from_response(response)
        return response_as_json, response_as_json["status"]
...
def book(client, user_id):
    ...
    def api_call_food():
        ...
        response = client.get(url=f"/api/v1/foodservice/foods/{departure_date}/shanghai/suzhou/D1345", name=get_name_suffix("get_food_types"))
        response_as_json = get_json_from_response(response)
        return response_as_json, response_as_json["status"]
    ...
    def api_call_ticket():
        ...
        response = client.post(url="/api/v1/preserveservice/preserve", json=body, catch_response=False, name=get_name_suffix("preserve_ticket"))
        response_as_json = get_json_from_response(response)
        return response_as_json, response_as_json["status"]
